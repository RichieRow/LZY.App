...
namespace LZY.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        public async Task<IActionResult> Index()
        {
            ...
            var response = await client.GetAsync("http://localhost:5003/weatherforecast");
        ...
        private async Task<string> RenewTokensAsync()
        {
            ...
            var tokenResponse = await client.RequestRefreshTokenAsync(new RefreshTokenRequest
            {
                ...
                Scope = "api1 email openid profile address phone",
        ...
        public async Task<IActionResult> AccessApis()
        {
            ...
            var response1 = await apiClient.GetAsync("http://localhost:4377/api/values");
